...
const LoginPage = () => {
    return (
            ...
            <div className="max-w-full md:max-w-4xl mx-auto mt-10 md:mt-28 shadow-2xl overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2 h-full">
                    ...
                    <div className="w-full bg-white p-4 md:p-12">
                        ...
                        <form >
                            <div className="mt-4">
                                <label className="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" htmlFor="LoggingEmailAddress">User name or Email</label>
        ...
        //     <div className="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl my-20" >
        ...
        //                 <a href="/" className="text-xl text-center text-gray-900 uppercase dark:text-gray-400 hover:underline">login with email</a>
