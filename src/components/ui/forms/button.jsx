...
const Button = ({ label, btnType = "button", btnBase, className, loading, ...props }) => {
    ...
    return (
        <button type={btnType} className={'px-2 py-1 tracking-wide transition-colors duration-200 transform rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 ' + btnClass + ' ' + className} {...props}>
